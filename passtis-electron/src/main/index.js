...
import {app, shell, BrowserWindow, Menu, dialog, Tray} from 'electron'
...
let mainWindow
let iconFile = __static + path.sep + 'passtis.png';
...
function createMainWindow() {
    ...
    let appTray = new Tray(__static + path.sep + 'icon.png');
